...
type NavItem = {
  href: string;
  labelKey: "verifications" | "users" | "farmarket" | "secondserve";
...
const ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    labelKey: "secondserve",
    icon: (
      <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2 M7 2v20 M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7" />
    ),
  },
];
