...
export async function updateFarmerProfile(
  ...
  const t = await getTranslations("farmer.settings.actions");
  ...
  if (!user) return { error: t("sessionExpired"), ok: false };
  ...
  if (error) return { error: t("saveFailed"), ok: false };
