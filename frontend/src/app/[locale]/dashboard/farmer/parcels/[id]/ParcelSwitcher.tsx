...
import type { ParcelOverviewEntry } from "@/app/[locale]/dashboard/farmer/overview-types";
...
export function ParcelSwitcher({ currentParcelId, parcels }: Props) {
  const t = useTranslations("farmer.parcels.detail.switcher");
              ...
              >
                ...
                {p.has_open_threshold_breach && (
                  <span
                    ...
                    aria-label={t("thresholdExceeded")}
                  />
                )}
              </button>
            </li>
