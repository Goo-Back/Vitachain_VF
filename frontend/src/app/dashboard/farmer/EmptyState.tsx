...
export function EmptyState() {
  return (
    <FadeIn className="mx-auto max-w-4xl py-8">
      <div className="vc-card relative overflow-hidden p-8 sm:p-12">
        <div className="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-sky-tint-50 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 h-64 w-64 rounded-full bg-leaf-100/60 blur-3xl" />
        ...
        <div className="relative">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
            Bienvenue sur <span className="katara-text">Katara</span>.
          </h1>
